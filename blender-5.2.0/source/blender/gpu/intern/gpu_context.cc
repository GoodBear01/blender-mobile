...
{
#ifdef __ANDROID__
  /* This unofficial Android build ships Vulkan only. User prefs still default
   * to OpenGL, which would fail, set G_FLAG_GPU_BACKEND_FALLBACK, then succeed
   * on Vulkan and show a false "Failed to load using Vulkan" alert. */
